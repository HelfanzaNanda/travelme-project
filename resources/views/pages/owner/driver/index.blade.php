...
@section('content')
    <div class="row page-titles">
        ...
        <div class="col-md-6 col-4 align-self-center">
            <a href="{{route('driver.create')}}" class="btn float-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i>Create</a>
        </div>
    </div>
    <!-- Start Page Content -->
    <div class="row">
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    <td><a class="avatar bg-danger" data-toggle="modal" data-target="#default{{$loop->iteration}}" type="button">
                                            <img src="{{asset('uploads/owner/driver/'.$data->avatar)}}" width="40" height="40">
                                        </a>
                                    </td>
                                    <td>{{$data->name}}</td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="d-flex justify-content-center">
                                                    <img src="{{asset('uploads/owner/driver/'.$data->avatar)}}" style="height: 480px; width: 480px;" >
                                                </div>
