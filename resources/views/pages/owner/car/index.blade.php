...
@section('content')
    <div class="row page-titles">
        ...
        <div class="col-md-6 col-4 align-self-center">
            <a href="{{route('car.create')}}" class="btn float-right hidden-sm-down btn-success mr-2"><i class="mdi mdi-plus-circle"></i>Tambah</a>
        </div>
    </div>
    <!-- Start Page Content -->
    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-toggle="modal" data-target="#default{{$loop->iteration}}" type="button">
                                            <img src="{{asset('uploads/owner/car/'. $data->photo)}}" width="40px" height="auto" alt="{{$data->photo}}">
                                        </a>
                                    </td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="d-flex justify-content-center">
                                                    <img src="{{asset('uploads/owner/car/'. $data->photo)}}" style="height: auto; width: 480px;" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
